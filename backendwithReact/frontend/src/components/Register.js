...
import { BsFillPersonFill, BsEnvelopeFill, BsKeyFill } from 'react-icons/bs';
                                        ...
                                        <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                            ...
                                            <form className="mx-1 mx-md-4">
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-4">
                                                    <BsFillPersonFill style={{ height: "30px", width: "30px", marginBottom: "25px" }} className="fas  fa-lg me-3 fa-fw" />
